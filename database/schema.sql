...
CREATE TABLE IF NOT EXISTS profile (
  ...
  title_id        VARCHAR(160)  NOT NULL DEFAULT '',
  bio             TEXT,
  bio_id          TEXT,
...
CREATE TABLE IF NOT EXISTS experiences (
  ...
  position_id   VARCHAR(160)  NOT NULL DEFAULT '',
  location      VARCHAR(120)  NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS projects (
  ...
  title_id        VARCHAR(200)  NOT NULL DEFAULT '',
  slug            VARCHAR(220)  NOT NULL UNIQUE,
  short_desc      VARCHAR(300)  NOT NULL DEFAULT '',
  short_desc_id   VARCHAR(300)  NOT NULL DEFAULT '',
  description     TEXT,
  description_id  TEXT,
...
CREATE TABLE IF NOT EXISTS education (
  ...
  degree_id        VARCHAR(160)  NOT NULL DEFAULT '',
  field_of_study   VARCHAR(160)  NOT NULL DEFAULT '',
  field_of_study_id VARCHAR(160) NOT NULL DEFAULT '',
